...
export const mockTeams: Team[] = [
  ...
  { id: 17, name: 'Aston Villa', short_name: 'AVL', league_id: 1, elo_rating: 1723 },
  { id: 18, name: 'Newcastle', short_name: 'NEW', league_id: 1, elo_rating: 1756 },
  { id: 19, name: 'West Ham', short_name: 'WHU', league_id: 1, elo_rating: 1708 },
  { id: 20, name: 'Brighton', short_name: 'BHA', league_id: 1, elo_rating: 1715 },
  { id: 21, name: 'Brentford', short_name: 'BRE', league_id: 1, elo_rating: 1698 },
  { id: 22, name: 'Crystal Palace', short_name: 'CRY', league_id: 1, elo_rating: 1685 },
  { id: 23, name: 'Fulham', short_name: 'FUL', league_id: 1, elo_rating: 1678 },
  { id: 24, name: 'Wolverhampton', short_name: 'WOL', league_id: 1, elo_rating: 1672 },
  { id: 25, name: 'Nottingham Forest', short_name: 'NFO', league_id: 1, elo_rating: 1665 },
  { id: 26, name: 'Bournemouth', short_name: 'BOU', league_id: 1, elo_rating: 1658 },
  { id: 27, name: 'Everton', short_name: 'EVE', league_id: 1, elo_rating: 1652 },
  { id: 28, name: 'Leicester City', short_name: 'LEI', league_id: 1, elo_rating: 1645 },
  ...
  { id: 29, name: 'Sevilla', short_name: 'SEV', league_id: 2, elo_rating: 1765 },
  { id: 30, name: 'Real Sociedad', short_name: 'RSO', league_id: 2, elo_rating: 1758 },
  { id: 31, name: 'Athletic Bilbao', short_name: 'ATH', league_id: 2, elo_rating: 1752 },
  { id: 32, name: 'Real Betis', short_name: 'BET', league_id: 2, elo_rating: 1745 },
  { id: 33, name: 'Villarreal', short_name: 'VIL', league_id: 2, elo_rating: 1738 },
  { id: 34, name: 'Valencia', short_name: 'VAL', league_id: 2, elo_rating: 1725 },
  { id: 35, name: 'Girona', short_name: 'GIR', league_id: 2, elo_rating: 1718 },
  { id: 36, name: 'Getafe', short_name: 'GET', league_id: 2, elo_rating: 1705 },
  { id: 37, name: 'Osasuna', short_name: 'OSA', league_id: 2, elo_rating: 1698 },
  { id: 38, name: 'Celta Vigo', short_name: 'CEL', league_id: 2, elo_rating: 1692 },
  { id: 10, name: 'Bayern Munich', short_name: 'BAY', league_id: 3, elo_rating: 1876 },
  { id: 39, name: 'Borussia Dortmund', short_name: 'BVB', league_id: 3, elo_rating: 1801 },
  { id: 40, name: 'RB Leipzig', short_name: 'RBL', league_id: 3, elo_rating: 1785 },
  { id: 41, name: 'Bayer Leverkusen', short_name: 'B04', league_id: 3, elo_rating: 1778 },
  { id: 42, name: 'Eintracht Frankfurt', short_name: 'FRA', league_id: 3, elo_rating: 1756 },
  { id: 43, name: 'Wolfsburg', short_name: 'WOB', league_id: 3, elo_rating: 1742 },
  { id: 44, name: 'Freiburg', short_name: 'SCF', league_id: 3, elo_rating: 1735 },
  { id: 45, name: 'Mainz 05', short_name: 'M05', league_id: 3, elo_rating: 1728 },
  { id: 46, name: 'Monchengladbach', short_name: 'BMG', league_id: 3, elo_rating: 1722 },
  { id: 47, name: 'Hoffenheim', short_name: 'HOF', league_id: 3, elo_rating: 1715 },
  { id: 48, name: 'Union Berlin', short_name: 'FCU', league_id: 3, elo_rating: 1708 },
  { id: 49, name: 'Stuttgart', short_name: 'VFB', league_id: 3, elo_rating: 1702 },
  ...
  { id: 50, name: 'Napoli', short_name: 'NAP', league_id: 4, elo_rating: 1785 },
  { id: 51, name: 'Juventus', short_name: 'JUV', league_id: 4, elo_rating: 1815 },
  { id: 52, name: 'Roma', short_name: 'ROM', league_id: 4, elo_rating: 1768 },
  { id: 53, name: 'Lazio', short_name: 'LAZ', league_id: 4, elo_rating: 1762 },
  { id: 54, name: 'Atalanta', short_name: 'ATA', league_id: 4, elo_rating: 1775 },
  { id: 55, name: 'Fiorentina', short_name: 'FIO', league_id: 4, elo_rating: 1745 },
  { id: 56, name: 'Bologna', short_name: 'BOL', league_id: 4, elo_rating: 1738 },
  { id: 57, name: 'Torino', short_name: 'TOR', league_id: 4, elo_rating: 1725 },
  { id: 58, name: 'Monza', short_name: 'MON', league_id: 4, elo_rating: 1715 },
  { id: 59, name: 'Lecce', short_name: 'LEC', league_id: 4, elo_rating: 1708 },
  { id: 60, name: 'Udinese', short_name: 'UDI', league_id: 4, elo_rating: 1702 },
  ...
  { id: 61, name: 'Lyon', short_name: 'LYO', league_id: 5, elo_rating: 1765 },
  { id: 62, name: 'Lille', short_name: 'LIL', league_id: 5, elo_rating: 1758 },
  { id: 63, name: 'Nice', short_name: 'NIC', league_id: 5, elo_rating: 1745 },
  { id: 64, name: 'Lens', short_name: 'LEN', league_id: 5, elo_rating: 1738 },
  { id: 65, name: 'Rennes', short_name: 'REN', league_id: 5, elo_rating: 1732 },
  { id: 66, name: 'Strasbourg', short_name: 'STR', league_id: 5, elo_rating: 1725 },
  { id: 67, name: 'Toulouse', short_name: 'TOU', league_id: 5, elo_rating: 1718 },
  { id: 68, name: 'Brest', short_name: 'BRE', league_id: 5, elo_rating: 1712 },
  { id: 69, name: 'Nantes', short_name: 'NAN', league_id: 5, elo_rating: 1705 },
  { id: 70, name: 'Reims', short_name: 'REI', league_id: 5, elo_rating: 1698 },
  { id: 71, name: 'Montpellier', short_name: 'MON', league_id: 5, elo_rating: 1692 },
  { id: 72, name: 'Le Havre', short_name: 'HAV', league_id: 5, elo_rating: 1685 },
  { id: 73, name: 'Angers', short_name: 'ANG', league_id: 5, elo_rating: 1678 },
  { id: 74, name: 'Saint Etienne', short_name: 'ETI', league_id: 5, elo_rating: 1672 },
  { id: 75, name: 'Manchester City', short_name: 'MCI', league_id: 6, elo_rating: 1915 },
  { id: 76, name: 'Real Madrid', short_name: 'RMA', league_id: 6, elo_rating: 1908 },
  { id: 77, name: 'Bayern Munich', short_name: 'BAY', league_id: 6, elo_rating: 1898 },
  { id: 78, name: 'Paris Saint-Germain', short_name: 'PSG', league_id: 6, elo_rating: 1845 },
  { id: 79, name: 'Inter Milan', short_name: 'INT', league_id: 6, elo_rating: 1848 },
  { id: 80, name: 'Barcelona', short_name: 'BAR', league_id: 6, elo_rating: 1856 },
  { id: 81, name: 'Liverpool', short_name: 'LIV', league_id: 6, elo_rating: 1868 },
  { id: 82, name: 'Arsenal', short_name: 'ARS', league_id: 6, elo_rating: 1835 },
  { id: 83, name: 'Atletico Madrid', short_name: 'ATM', league_id: 6, elo_rating: 1822 },
  { id: 84, name: 'Borussia Dortmund', short_name: 'BVB', league_id: 6, elo_rating: 1812 },
  { id: 85, name: 'RB Leipzig', short_name: 'RBL', league_id: 6, elo_rating: 1798 },
  { id: 86, name: 'Atalanta', short_name: 'ATA', league_id: 6, elo_rating: 1795 },
  { id: 87, name: 'Juventus', short_name: 'JUV', league_id: 6, elo_rating: 1825 },
  { id: 88, name: 'AC Milan', short_name: 'MIL', league_id: 6, elo_rating: 1815 },
  { id: 89, name: 'Benfica', short_name: 'BEN', league_id: 6, elo_rating: 1808 },
  { id: 90, name: 'Porto', short_name: 'POR', league_id: 6, elo_rating: 1805 },
  { id: 91, name: 'Sporting CP', short_name: 'SCP', league_id: 6, elo_rating: 1798 },
  { id: 92, name: 'Ajax', short_name: 'AJA', league_id: 6, elo_rating: 1792 },
  { id: 93, name: ' Feyenoord', short_name: 'FEY', league_id: 6, elo_rating: 1785 },
];
